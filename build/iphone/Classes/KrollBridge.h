...
@interface GoWorkoutObject : KrollCoverageObject {
#else
@interface GoWorkoutObject : KrollObject {
#endif
@private
...
extern NSString * GoWorkout$ModuleRequireFormat;
