...
/**
 Base class for all GoWorkout views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GoWorkout view hierarchy (such as wrapped iOS UIViews) was touched.
