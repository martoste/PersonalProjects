...
// in simulator we redefine to format for GoWorkout Developer console
...
{\
	NSString * exceptionName = [@"org.goworkout." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.goworkout";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGoWorkoutNativeItemNone = -1, 
	UIGoWorkoutNativeItemSpinner = -2,
	UIGoWorkoutNativeItemProgressBar = -3,
	
	UIGoWorkoutNativeItemSlider = -4,
	UIGoWorkoutNativeItemSwitch = -5,
	UIGoWorkoutNativeItemMultiButton = -6,
	UIGoWorkoutNativeItemSegmented = -7,
	
	UIGoWorkoutNativeItemTextView = -8,
	UIGoWorkoutNativeItemTextField = -9,
	UIGoWorkoutNativeItemSearchBar = -10,
	
	UIGoWorkoutNativeItemPicker = -11,
	UIGoWorkoutNativeItemDatePicker = -12,
	
	UIGoWorkoutNativeItemInfoLight = -13,
	UIGoWorkoutNativeItemInfoDark = -14,
	
	UIGoWorkoutNativeItemDisclosure = -15,
	
	UIGoWorkoutNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all GoWorkout instances of
