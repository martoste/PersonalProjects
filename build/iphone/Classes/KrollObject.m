...
//@interface GoWorkoutObject : NSObject
//@end

@interface GoWorkoutObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GoWorkoutObject class]])
		{
			for (NSString *key in [[(GoWorkoutObject*)o modules] allKeys])
			{
